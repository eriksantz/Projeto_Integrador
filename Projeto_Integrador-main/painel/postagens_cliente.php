...
$sqlPostagens = "SELECT id, titulo, descricao, imagem, criado_em, status, feedback_cliente 
                 FROM postagens 
                 WHERE cliente_id = ? 
        ...
        foreach ($postagens as $postagem) {
            ...
            <div class="postagem-card">
                ...
                <div class="card-conteudo">';
                    ...
                    // A descrição agora fica dentro do conteúdo
            ...
            echo '</div> ';
                    ...
                    // MOSTRA O FEEDBACK DO CLIENTE, SE EXISTIR
