...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['codigo'])) {
    ...
    if ($convite) {
        if ($convite_vinculado) {
            ...
            $sql_update_cliente = "UPDATE clientes SET convite_id = ? WHERE id = ?";
...
<body>
    ...
    <div class="popup-overlay" id="popupSucesso" style="display: none;">
        <div class="popup-content" style="align-items: center; text-align: center;">
            ...
            <!-- FIX: Removido o style="margin-top" para corrigir o espaçamento -->
    ...
    <script>
        ...
        const popupSucessoOverlay = document.getElementById('popupSucesso');
        ...
        popupSucessoOverlay.addEventListener('click', function(event) {
            if (event.target === popupSucessoOverlay) {
                fecharPopupSucesso();
            }
        });
