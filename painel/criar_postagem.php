...
$sql = "INSERT INTO postagens (cliente_id, titulo, descricao, data_publicacao, redes_sociais, imagem) 
        VALUES (?, ?, ?, ?, ?, ?)";

$stmt = $pdo->prepare($sql);
$stmt->execute([$cliente_id, $titulo, $descricao, $data_publicacao, $redes_sociais, $imagem]);
